...
namespace P1.Tests
{
    ...
    public class SquareMatrixTests
    {
        ...
        [TestMethod()]
        public void MiniDeterminantTest()
        {
           
        }

        [TestMethod()]
        public void determinantOfMatrixTest()
        {
            SquareMatrix<double> m4 = new SquareMatrix<double>(2)
            {
                new Vector<double>(2) { 1, 2},
                new Vector<double>(2) { 2, -1},

            };
            Assert.AreEqual(-5, SquareMatrix<double>.determinantOfMatrix(m4,2));
        }
        ...
        //    {
        //        new Vector<double>(3) { 10, 11, 12},
        //        new Vector<double>(3) { 20, 21, 22},
        //        new Vector<double>(3) { 30, 31, 32}
        //    };
        //   m.Adjugate()
